...
\begin{innerlist}
  ...
  \item Served on the scientific committee for the 2013 Bicycle and Motorcyle
    Dynamics Conference
  \item Mentored for Google Summer of Code (Python Software Foundation/SymPy/PyDy)
...
\begin{innerlist}
  \item On the influence of tyre and rider properties on the stability of a
    bicycle. Vera Bulsink, et. al, Vehicle System Dynamics, 2014.
  \item Are subject-specific musculoskeletal models robust to the uncertainties
    in parameter identification? Giordano Valente, et. al, PLoS One, 2014.
  \item Reviewed four papers for the BMD 2013 proceedings, July 2013.
