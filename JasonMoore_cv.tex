...
\begin{tabular}[t]{@{}p{\textwidth-\rcollength}p{\rcollength}}
	3113 Meadowbrook Blvd. & E-mail: \href{mailto:moorepants@gmail.com}{moorepants@gmail.com}\\
...
experimentation, computational reproducibility, open science
...
\begin{innerlist}
  \item 2013 Best Paper Award, Journal of Multibody Dynamics
\end{innerlist}
...
\begin{innerlist}
  \item Are subject-specific musculoskeletal models robust to the uncertainties
    in parameter identification?, Giordano Valente, et. al, PLoS One, April
  \item Review four papers for the BMD 2013 proceeding, July 2013.
...
\begin{outerlist}
  ...
  \begin{innerlist}
    \item Identified control schemes in human walking using data driven
      approaches
    \item Develop human walking models
...
Services, Ubuntu Server, Apache, \href{http://www.plone.org}{Plone}, Wordpress,
Joomla, Homesite, Microsoft Front Page, Macromedia Dreamweaver
