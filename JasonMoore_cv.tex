...
\begin{innerlist}
  ...
  \item Served on the scientific committee for the 2013 Bicycle and Motorcyle
    Dynamics Conference.
  \item Mentored for two Google Summer of Code (Python Software
...
\begin{innerlist}
  ...
  \item Revied ``Are subject-specific musculoskeletal models robust to the
  ...
  \item Reveiwed ``Experimental and Numerical Analysis of Rider Motion in Weave
...
\begin{outerlist}
  ...
  \begin{innerlist}
    \item Identified control schemes in human walking using data driven
      approaches.
    \item Developed software for gait data anaylysis and simulation.
    \item Developed human walking models.
