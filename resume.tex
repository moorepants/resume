...
\begin{outerlist}
  ...
  \begin{innerlist}
    ...
    \item (Co-)supervisor of 20 MSc students
...
%
\begin{outerlist}
  \item[] \textit{Delft University of Technology, PhD}
    \begin{innerlist}
      \item Christoph M. Schmidt, expected 2026 [co-promotor]
      \item Gabriele Dell'Orto, expected 2025 [co-promotor]
      \item Radoslaw Dukalski, expected 2023 [co-promotor]
      \item George Dialynas, PhD, 2020 [External member]
    \end{innerlist}
  \item[] \textit{Politecnico Milano, PhD}
    \begin{innerlist}
      \item Dario Savaresi, PhD, 2021 [External member]
      \item Alessandra Duz, PhD, 2021 [External member]
    \end{innerlist}
  \item[] \textit{Delft University of Technology, MSc, Supervisor}
    \begin{innerlist}
      ...
      \item Francesca Andretta, MSc, 2022
      \item Mirco Hogetoorn, MSc, 2022
  ...
  \item[] \textit{University of California, Davis}
    \begin{innerlist}
      ...
      \item Abraham McKay, MSc, 2018 [Chair \& primary advisor]
...
\begin{outerlist}
  \item[] \textit{Assistant Professor}%
    ...
    \begin{innerlist}
      ...
      \item Supervised 20 MSc students and participated in 15 MSc defenses.
    \end{innerlist}
\end{outerlist}
\href{http://www.ucdavis.edu}{\textbf{University of California at Davis}}, Davis, California USA
\begin{outerlist}
