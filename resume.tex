...
\begin{outerlist}
  ...
  \item[] Assistant Professor \hfill \textbf{August 2020 to Present} \\
    ...
    \\ (Chairs: H.~E.~J. Veeger [2020-Present])
...
\begin{outerlist}
  ...
  \item[] \textit{Delft University of Technology}
    \begin{innerlist}
      ...
      \item Joris Kuiper, MSc, 2021 [Daily supervisor]
...
%
\begin{innerlist}
\item NeuroLabNL Kleine, Small Projects for NWA routes 21/22, ``Cycling through
  the labyrinth: identifying independent and parallel control mechanisms for
  bicycle balance'', CO-PI,
  \euro100k
\end{innerlist}
