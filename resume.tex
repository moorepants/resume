...
\usepackage[sorting=none,backend=biber,bibencoding=utf8,maxbibnames=10]{biblatex} % load the package
...
\begin{tabular}[t]{@{}p{\textwidth-\rcollength}p{\rcollength}}
  Rotterdam, Netherlands                                   & Personal Website: \href{http://moorepants.info}{moorepants.info}\\
  \href{mailto:moorepants@gmail.com}{moorepants@gmail.com} & Lab Website: \href{https://mechmotum.github.io}{bicycle.tudelft.nl}\\
  +01-530-601-9791                                         & G-Scholar: \href{https://scholar.google.com/citations?user=i9c-QOYAAAAJ&hl=en}{tinyurl.com/jkm-gscholar}\\
...
\section{Language}
%
English [US] (mother tongue), Dutch [NL] (beginner), Spanish [GU] (beginner)
...
\begin{outerlist}
  ...
  \item[] Assistant Professor \hfill \textbf{August 2020 to Present} \\
    \emph{BioMechanical Engineering Department, Delft University of Technology}
    \\ (Chairs: H.~E.~J. Veeger [2020-2022], A. Schouten [2022-Present])

  \item[] Assistant Professor of Teaching \hfill \textbf{September 2015 to June
    2020} \\
    \emph{Mechanical and Aerospace Engineering Department, University of
    California, Davis} \\ (Chairs: C.~P. van Dam [2015-2016], Stephen~K.
    Robinson [2016-2019], Cristina~E. Davis [2019-2020])
...
\item[] M.Sc., \href{http://mae.ucdavis.edu/}{Mechanical and Aeronautical
  ...
  \begin{innerlist}
    ...
    \item Lab: UCD Sports Biomechanics Lab
  \end{innerlist}
...
\item[] B.Sc.,
        \href{http://eng.odu.edu/me/}
             {Mechanical Engineering}, December 19, 2004
        \begin{innerlist}
...
\href{https://ths.pcs.k12.va.us}{\textbf{Tunstall High School}},
...
%
\href{http://www.tudelft.nl}{\textbf{Delft University of Technology}}, Delft, The Netherlands
\begin{outerlist}
  \item[] \textit{Assistant Professor}%
        \hfill \textbf{August 2020 to Present}
  \begin{innerlist}
    \item Principal Investigator of the \href{http://mechmotum.github.io}{TU
      Delft Bicycle Lab}
    \item Principal Investigator of the Infant Vibration in Transport project
    \item Project lead of the NWO Perspectief
      \href{https://www.citiusaltiussanius.nl/}{Citius Altius Sanius} P9
      Project: Fall Prevention in Consumer and Elite Cycling
    \item Co-Principal Investigator of the "Advancing Biomechanical Modeling by
      Improving SymPy Code Generation" CZI funded project.
    \item Principal Investigator of the ClickNL "Bicycle of the Future" project
    \item Supervisor of 5 postdoctoral researchers
    \item Co-promotor of 4 PhD candidates
    \item (Co-)advisor of 30+ MSc students
    \item Collaborations with Team Picnic-PostNL, Team DSM, ICTech, Royal Dutch
      Gazelle, Garmin/Tacx, Prinoth, Quantsight, Bosch ebike Systems, SymPy,
      VeiligheidNL
  \end{innerlist}
...
\section{Postdoctral Researcher Supervision}
%
\begin{outerlist}
  \item[] \textit{Delft University of Technology}
  \begin{innerlist}
    \item Dr. Jules Ronné 2024-2025
    \item Dr. Gabriele Dell'Orto, 2024-2025
    \item Dr. Leila Alizadehsaravi, 2021-2024
    \item Dr. Samuel Brockie, 2022-2023
    \item Dr. Andrew Dressel, 2022-2023
  \end{innerlist}
\end{outerlist}
...
%
\begin{outerlist}
  \item[] \textit{Delft University of Technology, PhD, Co-promotor}
    \begin{innerlist}
      \item Benjamín E. González T., expected 2028
      \item Christoph M. Schmidt, expected 2027
      \item Gabriele Dell'Orto, February 2025
      \item Radoslaw Dukalski, expected 2026
    \end{innerlist}
  \item[] \textit{University of Pavia, PhD, Visiting Supervisor}
    \begin{innerlist}
      \item José Alfonso Farías Fuentes, expected 2026
    \end{innerlist}
  \item[] \textit{Université Claude Bernard Lyon 1, PhD, Visiting Supervisor}
    \begin{innerlist}
      \item Jules Ronné, 2024
    \end{innerlist}
  \item[] \textit{Delft University of Technology, MSc, Supervisor}
    \begin{innerlist}
      \item Matthijs can den Broek, MSc, expected 2026
      \item Joris Scholten, MSc, expected 2026
      \item Philipp Jonas, MSc, expected 2026, [Co-Supervisor]
      \item Haye Boonstra, MSc, expected 2026
      \item Siva Machavaram, MSc, expected 2026, [Co-Supervisor]
      \item Stephen Lin, MSc, expected 2026
      \item Luna Compen, MSc, expected 2026
      \item Quentin Bongers, MSc, expected 2026
      \item Dana van der Pol, MSc, expected 2026
      \item Ruben Terwint, MSc, 2025, [Co-Supervisor]
      \item Yuke Huang, MSc, 2026
      \item Looka Schoneveld, MSc, expected 2025
      \item Eloy Vázquez Fernández, MSc, 2025
      \item Neville Nieman, MSc, expected 2025
      \item Anna Marbus, MSc, 2025
      \item Sara Youngblood, MSc, 2025
      \item Bart de Vries, MSc, 2025
      \item Sietse Soethout, MSc, 2024
      \item Thomas Habing, MSc, expected 2024
      \item Kenneth Pasma, MSc, 2024
      \item Marten Haitjema, MSc, 2023
      \item Kirsten Dijkman, MSc, 2024
      \item Timo Stienstra, MSc, 2023
      \item Jan van der Schot, MSc, 2023
      \item Floris van Willigen, MSc, 2023
      \item Julie van Vlerken, MSc, 2023
      \item Jens Keijser, MSc, 2023
      \item Jan Heinen, MSc, 2022
      \item Dorus de Boer, MSc, 2022
      \item Simonas Draukšas, MSc, 2022
      \item Daniël Landré, MSc, 2022
      \item Ajaypal Singh, MSc, 2022
      \item Francesca Andretta, MSc, 2022 [Co-Supervisor]
      \item Mirco Hogetoorn, MSc, 2022 [Co-Supervisor]
      \item Joris Kuiper, MSc, 2021
    \end{innerlist}
  \item[] \textit{University of California, Davis, MSc, Advisor}
    \begin{innerlist}
      \item Scott Kresie, MSc, 2021 [Co-Advisor]
      \item Abraham McKay, MSc, 2018
      \item Farhad Ghadamli, MSc, 2017 [Co-Advisor]
      \item Sui Nam Chan, MSc, 2017 [Co-Advisor]
    \end{innerlist}
\end{outerlist}
...
%
\begin{outerlist}
  \item[] \textit{Delft University of Technology, PhD, External Member}
    \begin{innerlist}
      \item George Dialynas, PhD, 2020
    \end{innerlist}
  \item[] \textit{Politecnico Milano, PhD, PhD, External Member}
    \begin{innerlist}
      \item Dario Savaresi, PhD, 2021
      \item Alessandra Duz, PhD, 2021
    \end{innerlist}
  \item[] \textit{Delft University of Technology, MSc, External Member}
    \begin{innerlist}
      \item Luuk Withagen, MSc, 2023
      \item Gabriele Ansaldo, MSc, 2023
      \item Skirmantas Pargalgauskas, MSc, 2022
      \item Levi Keift, MSc, 2022
      \item Suzanne Rademakers, MSc, 2022
      \item Jelle den Daas, MSc, 2022
      \item Noa Leijdesdorff, MSc, 2021
      \item Robert Rooijmans, MSc, 2021
      \item Núria Mora Vilaseca, MSc, 2021
      \item Boyan Klifman, MSc, 2021
      \item Gert Galis, MSc, 2021
      \item Alex Paulwels, MSc, 2021
      \item Jelle Kelbling, MSc, 2020
      \item Koen Wendel, MSc, 2020
    \end{innerlist}
\end{outerlist}
...
\begin{outerlist}
  \item[] \textit{Assistant Professor}%
    \hfill \textbf{August 2020 to Present}
    \begin{innerlist}
      \item Taught ``\href{https://moorepants.github.io/me40155}{Multibody
        Dynamics}'', Q3/Q4 2022/2023/2024/2025, 160-220 students, MSc core
        course, 2 junior lecturers, 3 teaching assistants, flipped course
        design with 20 lecture videos, wrote an interactive textbook, develop
        set of autograded computational homeworks
      \item Taught ``\href{https://moorepants.github.io/me40135}{Special Topics
        in Sports Engineering}'', Q4 2021/2022/2023/2024/2025, 25-45 students,
        MSc elective course, 1 teaching assistant
      \item Supported 5 BSc final projects.
      \item Supervised 27 MSc students and participated in 31 MSc defenses.
    \end{innerlist}
\end{outerlist}
...
%
\href{}{TU Delft Faculty ME}
\begin{innerlist}
  \item Vibration Health Effects of Children in Vehicles, ME Theme Proposal,
    2025, CO-PI, \euro15k.
\end{innerlist}
...
\href{}{Veiligheid.nl}
\begin{innerlist}
  \item Vibration Health Effects of Children in Vehicles, 2024, CO-PI,
    \euro65k.
\end{innerlist}
...
\begin{innerlist}
  \item Modeling bicycle behavior from visual stimulus to neuromuscular control
    ability, 3mE Cohesion Proposal, 2023, CO-PI, \euro100k.
\end{innerlist}

\blankline

\href{}{TU Delft Climate Action Research and Education Seed Call}
\begin{innerlist}
  \item Sustainable transportation planning via bicycle-based data collection,
    2023, CO-PI, \euro30k.
\end{innerlist}
...
\href{https://www.4tu.nl/nirict}{4TU.NIRICT}
\begin{innerlist}
...
%
\begin{innerlist}
  \item CoCycle, Pathfinder Program, European Innovation Council, 2024, PI,
    \euro3M
  \item Towards SymPy 2.0: Sustaining Open Source Symbolic Mathematics for
    Science, Essential Open Source Software for Science, Cycle 6, Chan
    Zuckerberg Initiative, March 2024, CO-PI, \$400K.
  \item Bicycling through the labyrinth: unraveling balance control in
    human-machine interfaces, Nederlandse Organisatie voor Wetenschappelijk
    Onderzoek, Open Competition XS, 2022, CO-PI, \euro70k.
  \item NeuroLabNL Kleine, Small Projects for NWA routes 21/22, ``Cycling
    through the labyrinth: identifying independent and parallel control
    mechanisms for bicycle balance'', CO-PI, \euro100k
  \item Cycling through the labyrinth: independent and parallel control
    mechanisms for bicycle balance, Nederlandse
    Organisatie voor Wetenschappelijk Onderzoek, Open Competition XS, 2021, \euro70k.
  \item Sustaining and Growing Engineering Preprints with engrXiv, Nederlandse
    Organisatie voor Wetenschappelijk Onderzoek, \euro26k.
  \item YottaBike: Single-Track Vehicle and Rider Data Harmonization to
    Maximize Interoperability and Reusability, Nederlandse Organisatie voor
    Wetenschappelijk Onderzoek, \euro45k.
  \item Bicycle Dynamics Analysis App, TU Delft Digital Competence Center
    Support, PI, 2021, around \euro5K.
  \item Learning to Bicycle with Robotic Assistance, TU Delft 3mE Cohesion
    Proposals, CO-PI, 2021, \euro66K.
  \item Collaborative Research: Dissemination of the LibreTexts Libraries
    through Expansion and Training in Digital Interfaces to Enhance Science
    Education across the Nation, National Science Foundation, CO-PI, 2018-2022,
    \$3M. \href{http://nsf.gov}{National Science Foundation}
  \item Collaborative Research: SI2-SSI: Infrastructure for Cross-Disciplinary
    Scientific Computation Through Optimized Symbolic Code Generation with
    SymPy, National Science Foundation, CO-PI, 2017-2019, \$3M.
    \href{http://nsf.gov}{National Science Foundation}
\end{innerlist}

\section{Industry Collaborations}
\begin{innerlist}
  \item Prinoth, 2022-2023
  \item Quantsight, 2021-2023
  \item Garmin/Tacx, 2022-2023
  \item Royal Dutch Gazelle, 2020-2024
  \item Bosch E-Bike Systems, 2020-present
  \item SWOV, 2020-2024
  \item Team DSM/Picnic-PostNL, 2020-present
  \item Hegemony Technologies LLC, 2018-2020
  \item Buffalo Bikes
  \item Wetlands Work!
  \item Plotly Inc.
  \item SymPy, 2009-present
\end{innerlist}


% Notes on the Zotero bib:
% - Journal Article: only submitted, under review, or published articles. Add
%   (Submitted/Under Review/Accepted) to the Journal title if not published
%   yet.
% - Conference Paper: only for conferences that have actual papers (5+ pages),
%   attach the Submitted/Under Review/Accepted to conference name or
%   proceedings title.
% - Preprint: for papers that we've actually put up on an external preprint
%   server that has a URL and DOI.
% - Presentation: For confernece presentations that are only based on abstracts
%   (even if the abstract is published). TODO: The meeting name doesn't seem to
%   show up in bibtex render. You can add the name of the conference in place
%   for it to add to address in bibtex.
% - Manuscript: for working papers that are drafts and not yet a preprint.
...
\begin{innerlist}
  ...
  \item Board Member of the \href{http://engrxiv.org}{Engrxiv: Preprint Server}
    (April 2019-present)
  \item Co-Editor of the \href{http://jose.theoj.org/}{Journal of Open Source
    Education} (2017-2025)
...
%
\begin{innerlist}
  \item Reviewed ``Effects of cycling on spine morphology: a pilot study using
    a 3D scanning method'', PeerJ, 2023.
  \item Reviewed ``A Double Gyroscope Concept Approach for A 2-Wheel Vehicle''
    for Vehicle System Dynamics, 2020-09.
  \item Reviewed ``gym-electric-motor (GEM): A Python toolbox for the
    simulation of electric drive systems'' for the Journal of Open Source
    Software, 2020-08,
    \url{https://github.com/openjournals/joss-reviews/issues/2498}.
  ...
  \item Reviewed ``A data set with kinematic and ground reaction forces of
    human balance'' for PeerJ, 2017, \url{https://peerj.com/articles/3626/}.
  \item Reviewed ``Motion analysis of a device including a disk and two slender
    ...
    Open Engineering, 2017, \url{https://doi.org/10.21428/572e5da9}.
  \item Reviewed ``Optlang: A Python interface to common mathematical
    optimization solvers'' for the Journal of Open Source Software, 2016-12.
    \url{http://dx.doi.org/10.21105/joss.00139}
  \item Reviewed ``The Loop Closure Equation for the Pitch Angle in Bicycle
    Kinematics'' for Vehicle System Dynamics, 2015-06.
  \item Reviewed ``The effect of tyre and rider properties on the stability of
    a bicycle'' by Bulsink, Vera, et. al, for Advances in Mechanical
    Engineering, 2015, \url{https://doi.org/10.1177/1687814015622596}.
  ...
  \item Reviewed ``Self-driving Lego Mindstorms Robot'' for SciPy 2014
    Proceedings, 2014,
    \url{https://github.com/scipy-conference/scipy_proceedings_2012/issues/12}.
  ...
  \item Reviewed ``Experimental and Numerical Analysis of Rider Motion in Weave
    ...
    \url{https://doi.org/10.1080/00423114.2011.621542}.
\end{innerlist}
...
\begin{outerlist}
\item[]
  \href{http://tinyurl.com/sacpy-jupy}{\textit{What to do when chicks go bad in your flock: JupyterHub on Bare Metal with Kubernetes}}
    \hfill \textbf{November~14,~2019}
\end{outerlist}
...
%
\href{http://www.ucdavis.edu}{\textbf{UC Davis}}, Davis, CA, USA
\begin{outerlist}
...
%
\href{https://acrossthecauseway.com/}{\textbf{Across the Causeway Transit
Collective}}, Davis \& Sacramento, CA, USA
\begin{outerlist}
  \item[] \textit{Member, Organizer, and Facilitator}%
    \hfill \textbf{July 2019 to June 2020}
  \begin{innerlist}
    \item Transit advocacy for a better city-to-city commuter route.
  \end{innerlist}
\end{outerlist}
...
\href{http://moorepants.info}{moorepants.info} [Pelican],
...
\begin{outerlist}
  \item[] Academic Research
    \begin{innerlist}
      ...
      \item Dr. Riender Happee,
        \emph{Collaborator and Co-author},
        Professor,
