...
\begin{outerlist}
  ...
  \begin{innerlist}
    ...
    \item Project lead of the ClickNL "Bicycle of the Future" project
...
\begin{innerlist}
  \item Modeling bicycle behavior from visual stimulus to neuromuscular control
    ability, 3mE Cohesion Proposal, 20230, CO-PI, \euro100k.
\end{innerlist}
...
\begin{innerlist}
  \item Bicycling through the labyrinth: unraveling balance control in
    ...
    Onderzoek, Open Competition XS, 2022, \euro70k.
