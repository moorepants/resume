...
\begin{outerlist}
  ...
  \begin{innerlist}
    ...
    \item Collaborations with Team DSM, ICTech, Royal Dutch Gazelle,
      Garmin/Tacx, Prinoth, Quantsight, Bosch ebike Systems, SymPy,
      VeiligheidNL
  \end{innerlist}
...
\begin{outerlist}
  \item[] \textit{Delft University of Technology, PhD, Co-promotor}
    \begin{innerlist}
      ...
      \item Christoph M. Schmidt, expected 2026
  ...
  \item[] \textit{University of Pavia, PhD, Visiting Supervisor}
    \begin{innerlist}
      \item José Alfonso Farías Fuentes, expected 2025
    \end{innerlist}
  ...
  \item[] \textit{Delft University of Technology, MSc, Supervisor}
    \begin{innerlist}
      ...
      \item Ruben Terwint, MSc, 2025
      \item Yuke Huang, MSc, expected 2025
