...
White House
\begin{innerlist}
  \item Selected for the first Phase of the White House's Apps for Vehicles
    Challenge, \$2K.
\end{innerlist}
...
\begin{innerlist}
  ...
  \item Served on the scientific committee for the 2013 Bicycle and Motorcycle
    Dynamics Conference.
  \item Organized and mentored for two Google Summer of Code (Python Software
...
\begin{innerlist}
  \item Reviewed ``Gyro device for bicycle handling assessment: A reliability
    ...
    2015.
  \item Reviewed ``On the influence of tyre and rider properties on the stability of a
    bicycle.'' by Vera Bulsink, et. al, for Vehicle System Dynamics, 2014.
...
\begin{outerlist}
  ...
  \begin{innerlist}
    \item Identified control schemes in human walking using data driven
      approaches.
    \item Developed and ran gait multi-subject gait experiments with a modern
      gait lab.
    ...
    \item Led ``Open Source Code Nights'' with the student IEEE group.
