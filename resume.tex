...
\begin{outerlist}
  ...
  \item[] Assistant Professor of Teaching MAE \hfill \textbf{September 2015 to present} \\
    ...
    Robinson [2016-2019], Cristina~E. Davis [2019-Present])
  ...
  \item[] \textit{Assistant Professor of Teaching MAE}%
    ...
    \begin{innerlist}
      \item Taught ``\href{https://moorepants.github.io/eme171/}{Analysis,
        ...
        40-60 students, upper level elective, 1 teaching assistant, developed
        new simulation guide, integrated active learning problems during class,
        created Segway control module, redesigned computational lab assignments
