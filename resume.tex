...
qualities, human biomechanics, gait control identification, exoskeleton
control, machine design, appropriate technology, human powered machines,
system identification, software engineering, wind tunnel experimentation,
computational reproducibility, open science, optimal control, computer aided
algebra
...
\begin{outerlist}
  ...
  \begin{innerlist}
    \item Led the \href{http://mechmotum.github.io}{Laboratorium of Marvelous
      Mechanical Motum}
    ...
    \item Design of an efficient human powered irrigation pump: mentored one
      graduate student and two graduate students in this research/design
      effort, partnered with World Bicycle Relief and Buffalo Bikes
    \item Identification of human standing control: mentored eight
...
\begin{outerlist}
  \item[] \textit{Assistant Teaching Professor, LPSOE}%
    ...
    \begin{innerlist}
      ...
      \item Taught \href{https://moorepants.github.io/eme185/}{Mechanical
      ...
      \item Member of two MSc committees
    \end{innerlist}
  \item[] \textit{Lecturer}%
...
%
\begin{innerlist}
  \item Editor of the Journal of Open Source Education
  \item Editor of the Journal of Open Engineering
  \item UCD MAE Undergraduate Committee (January 2017-Present)
  \item UCD MAE Website Committee (2017-Present)
...
\begin{outerlist}
  \item[] \textit{Computational Thinking in the Engineering Curriculum}
