...
\begin{innerlist}
  ...
  \item Served on the scientific committee for the 2013, 2016, and 2019 Bicycle
    and Motorcycle Dynamics Conferences reviewing 50+ abstracts for each
    conference.
...
\begin{outerlist}
  \item[] \textit{Eight Ways to Use Computation to Teach Everything Else}
...
\item[] \textit{\href{https://youtu.be/3QWKDGe528c}{Resonance: Learning
  ...
  presented by Kenneth Lyons (402 views)
...
\begin{outerlist}
  \item[] \textit{Multibody Dynamics and Control with Python} (6,114 views)
