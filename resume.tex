...
\begin{tabular}[t]{@{}p{\textwidth-\rcollength}p{\rcollength}}
  ...
  +01-530-601-9791           & G-Scholar: \href{https://scholar.google.com/citations?user=i9c-QOYAAAAJ&hl=en}{tinyurl.com/jkm-gscholar}\\
                             & Linkedin: \href{http://www.linkedin.com/pub/jason-moore/40/550/322}{tinyurl.com/jkm-linkedin}\\
                             & Twitter: \href{https://twitter.com/moorepants}{@moorepants}\\
                             & Google+: \href{https://plus.google.com/110966557175293116547}{tinyurl.com/jkm-plus}
\end{tabular}
...
science, optimal control, computer aided algebra

\section{Academic Employment}
%
\begin{outerlist}

  \item[] Assistant Teaching Professor (LPSOE) \hfill \textbf{September 2015 to present} \\
    \emph{Mechanical and Aerospace Engineering Department, University of California, Davis} \\
    (Chairs: C.P. van Dam (2015-2016), Stephen Robinson (2016-))
  ...
  \item[] Visiting Fulbright Scholar \hfill \textbf{August 2008 to August 2009} \\
    \emph{Bicycle Dynamics Laboratory, Delt University of Technology} \\
    (PI: A.L. Schwab)

  %\item[] Student Machine Shop Instructor \hfill \textbf{January 2007 to June 2008} \\
    %\emph{Mechanical and Aerospace Engineering Department, University of
    %California, Davis} \\
    %(Supervisor: Jeffery Feerer)
...
\item[] Ph.D., \href{http://mae.ucdavis.edu/}{Mechanical and Aerospace
  ...
  \begin{innerlist}
    ...
    \item Area of Study: Multibody dynamics, control systems, biomechanics, and
...
%
\href{http://todo.edu}{UC Davis Global Affairs}
\begin{innerlist}
\item \href{https://doi.org/todo}{
...
%
\href{}{United States Department of Education}
\begin{innerlist}
...
\item Collaborative Research: Dissemination of the LibreTexts Libraries through
  ...
  across the Nation, 2018-2022, \$5M.
...
\begin{outerlist}
  ...
  \begin{innerlist}
    \item Optimal bicycle design: mentored one graduate and two undergraduates
      students in an experimental study on bicycle handling, developed and
      optimization algorithm to discover optimal handling bicycle designs
    \item Smartphone rowing data backed coach: Worked with local startup and
      one undergraduate in a data science and dynamics project to predict
      rowing motions from smartphone data
    \item Design of an efficient human powered irrigation pump: mentored one
      graduate student in this research/design effort, partnered with World
      Bicycle Relief and Buffalo Bikes
    \item Identification of human standing control: mentored four
      undergraduates in the design of a double pendulum balancing robot
  \end{innerlist}
...
\href{http://www.ucdavis.edu}{\textbf{University of California at Davis}}, Davis, California USA
\begin{outerlist}
  \item[] \textit{Assistant Teaching Professor, LPSOE}%
    \hfill \textbf{September 2015 to Present}
    \begin{innerlist}
      ...
      \item Taught \href{https://moorepants.github.io/eme185/}{Mechanical Systems
        Design Project}, Winter/Spring 2016/2017, 140-160 students, 4 teaching
        assistants, capstone design course, mentored 55+ projects for industry
        clients
      \item Taught \href{https://moorepants.github.io/mae297/}{Mechanical and
        Aerospace Engeering Graduate Seminar}, Spring 2017, invited 10 guest
      ...
      \item Partipated in the Engineering Education Learning Community
      \item Mentored 2 graduate students, 16 undergraduates
      \item Member of two MS committees
    \end{innerlist}
  \item[] \textit{Lecturer}%
...
%
\begin{innerlist}
  \item UCD MAE Undergraduate Committee
  \item UCD MAE Website Committee
  \item Co-organizer of the 6th Annual International Cycling Safety
    Conference.
  \item Served on the organizing and scientific committees for the 2016 Bicycle
    and Motorcycle Dynamics Conference in Milwaukee, Wisconsin.
...
\textbf{Data Science Initiative}, Davis, CA, USA
\begin{outerlist}
  \item[] \textit{Computational Engineering Curriculum}
...
\begin{outerlist}
  \item[] \textit{Automatic Code Generation With SymPy} (2,015 views)
    \hfill \textbf{July~10,~2017}
\end{outerlist}
...
\begin{outerlist}
\item[] \textit{Simulating Robot, Vehicle, Spacecraft, and Animal Motion} (3,355 views)
...
\begin{outerlist}
  \item[] \textit{Multibody Dynamics and Control with Python} (3,817 views)
...
\textbf{PYCON 2014}, Montreal, Quebec, Canada (2,608 views)
\begin{outerlist}
...
\textbf{UC Davis}, Davis, CA
\begin{outerlist}
\item[]
  \href{}{\textit{Education
  Brownbag}}
...
\begin{outerlist}
  ...
  \item[] Teaching
    \begin{innerlist}
      \item Dr. Michael Hill
        \emph{New Faculty Mentor},
        Professor,
        University of California, Davis,
        Mechanical and Aerospace Engineering Department,
        One Shields Avenue, Davis, CA 95616,
