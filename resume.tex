...
\begin{outerlist}
  ...
  \begin{innerlist}
    ...
    \item Identification of human standing control: mentored ten undergraduates
      ...
      studies
    \item Member of three MSc committees
  \end{innerlist}
...
\begin{outerlist}
  ...
  \begin{innerlist}
    ...
    \item Abraham McKay, MSc [Chair], 2018
    \item Jason Chan, MSc
    \item Farhad Gahdamli, MSc
  \end{innerlist}
\end{outerlist}
...
\begin{innerlist}
  \item Reviewed 54 abstracts for the 2019 Bicycle and Motorcycle Dynamics
    Conference.
  \item Reviewed Kinematics paper on the Juornal of Open Engineering
  \item Reviewed PLoS One article on human subject specific
...
\textbf{University of Wisconsin-Stout}, Menominee, WI, USA
\begin{outerlist}
\item[]
  \href{}{\textit{Estimating Rowing Kinematic Metrics: An Undergraduate Sports
