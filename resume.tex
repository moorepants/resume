...
\begin{outerlist}
  ...
  \begin{innerlist}
    \item Development of a smartphone rowing coach
    \item Optimal bicycle design
    \item Experimentation validation of bicycle handling quality metric
  \end{innerlist}
...
\href{http://www.ucdavis.edu}{\textbf{University of California at Davis}}, Davis, California USA
\begin{outerlist}
  \item[] \textit{Lecturer wit Potential Security of Employment}%
        \hfill \textbf{September 2015 to Present}
  \begin{innerlist}
    \item Taught Introduction to Mechanical Vibrations, Fall 2016/2017, 20-40
      students, upper level elective, redesigned entire course second time
      teaching it to focus on active learning and computational thinking,
      developed interactive open access textbook
    \item Taught Multibody Dynamics, Fall 2017, 12 students, graduate course
    \item Taught Mechanical Systems Design Project, Winter/Spring 2016/2017,
      140-160 students, 4 teaching assistants, capstone design course
    \item Taught Graduate Seminar, Spring 2017
    \item Taught
    ``\href{http://moorepants.github.io/eme150a}{Mechanical
    Design}'', required upper level course, 20-35 students,
  \end{innerlist}
  \item[] \textit{Lecturer}%
